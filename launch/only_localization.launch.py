...
def generate_launch_description():
    ...
    configuration_basename = LaunchConfiguration('configuration_basename', default='only_loc.lua')
    map_filename = LaunchConfiguration('map_filename', default='/home/nfrancinelli/drone_ws/src/tf2_broadcaster/cfg/final_traj.pbstream')
